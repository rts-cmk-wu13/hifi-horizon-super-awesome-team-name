  ...
  return (
        <div className="faq-card">
            ...
            <p className="margin-top">We aim to resolve any problems to your satisfaction.
             ...
             All items excluding ex-display and secondhand goods are covered by at least 12 months warranty; this is detailed on your receipt. 
             Any secondhand or ex-display product is covered by at least 3 months warranty as noted in the original listing.
             HiFi Horizon cannot guarantee against any misuse (i.e. blown speakers etc.), 
             ...
             <div className="margin-top">
                ...
                <p>2 Joppa Road, Mackenzie House, Edinburgh, EH15 2EU.
                   If you would like to return an item, please note that we cannot arrange a collection of the item without additional cost; you will be responsible for ensuring the product reaches us. Shipping costs are non-refundable. If you receive a refund, the cost of return shipping will be deducted from your refund. 
             ...
             <div className="margin-top">
                ...
                <p>Please check the condition of all products delivered as soon as they are received. This does not affect your statutory rights. If there is a problem we would like to deal with this as soon as possible to alleviate any inconvenience to yourself.
                   ...
                   If your product is visibly damaged in transit, please sign for the delivery as ‘damaged’ and let us know as soon as possible.</p>
             </div>
             <div className="margin-top">
                <h3>RETURNS PROCESS/YOUR STATUTORY RIGHTS</h3>
                <p>If you wish to return goods purchased online or over the phone, you should notify HiFi Horizon of your intention to do so within 14 days of the date of receipt.</p>
                <p>You then have an additional 14 days to return the goods from this notification date (goods must be returned within 28 days). We will in such circumstances refund you the cost of your order, excluding postage or delivery cost. However, 
             ...
             <div className="margin-top">
                <h3>EXCHANGES</h3>
                <p>We can only replace items if they are defective or damaged. If you need to exchange the product for the same item due to a fault, please first send us an email at sales@hifi-horizon.com and once approved, send your item to:</p>
                <p>HiFi Horizon, 2 Joppa Road, Mackenzie House, Portobello, Edinburgh, EH15 2EU.</p>
